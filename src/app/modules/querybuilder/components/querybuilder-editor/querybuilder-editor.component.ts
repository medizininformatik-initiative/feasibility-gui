...
export class QuerybuilderEditorComponent implements OnInit, OnDestroy, AfterViewChecked {
  ...
  keysToSkip = ['id'];
  listItems: Array<SearchTermListItem> = [];
  ...
  startRequestingResult(): void {
    ...
    this.subscriptionPolling = this.resultObservable$.subscribe(
      ...
      (error) => {
        /* eslint-disable */console.log(...oo_oo(`1862750045_166_8_166_26_4`,error))
      ...
      () => {
        /* eslint-disable */console.log(...oo_oo(`1862750045_177_8_177_27_4`,'done'))
