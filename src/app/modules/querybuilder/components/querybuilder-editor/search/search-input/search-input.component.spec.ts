...
import { SearchTreeOverlayComponent } from '../search-tree-overlay/search-tree-overlay.component'
...
describe('SearchInputComponent', () => {
  ...
  it('should close overlay', () => {
    ...
    // trigger the click
    const button = document.querySelector('.cdk-overlay-container num-search-tree-overlay')
