...
export class FeatureProviderService {
  ...
  setTheme(oldTheme: string, newTheme: string): void {
    ...
    if (newTheme === 'bzkfTheme') {
      document.getElementById('header-logo').setAttribute('src', 'assets/img/bzkf_logo_gross.png')
      document.getElementById('header-logo').setAttribute('alt', 'BZKF Logo')
      document.getElementById('footer-logo').setAttribute('src', 'assets/img/bzkf_logo_gross.png')
