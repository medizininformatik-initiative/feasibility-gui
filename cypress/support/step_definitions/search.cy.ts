...
defineStep('I type {string} in the search input field', (text: string) => {searchInstance.typeInInputField(text)});
defineStep('I clear the search input field', () => {searchInstance.clearInputField()});