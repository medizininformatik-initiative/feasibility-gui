...
Scenario Outline: I edit <criterium> criterium 
    ...
    Then the button "Machbarkeitsabfrage" should be enabled
    When I click on the button "Machbarkeitsabfrage"
    Then I am on the "Feasibility Result" page
    When I click on the button "Kohortenselektion bearbeiten"
